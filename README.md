...
## **今期アニメの配信比率を分析する可視化アプリ**

**配信アニメを最も多く扱うサブスクを自動分析し、見やすいグラフと一覧で表示する Django アプリです。**

📊 CSV取込 → 🎨 棒グラフ表示 → 📋 ページネーション一覧 → 🔎 作品詳細へジャンプ
...
# 🚀 プログラムの概要
本アプリケーションは、今期配信アニメを一番網羅しているサブスクリプションを棒グラフで可視化します。
...
- `pie_chart.js`: 棒グラフのデータを設定＋ページネーション（非同期処理）の制御
